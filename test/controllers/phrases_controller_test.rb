...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference("Phrase.count") do
      post phrases_url, params: { phrase: { audio_id: @phrase.audio_id, body: @phrase.body } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { audio_id: @phrase.audio_id, body: @phrase.body } }
